...
def calcProjection(oeil):
	...
	IOD = 5
	if oeil == "gauche" : ex = ex-IOD
	elif oeil == "droit" : ex = ex + IOD
...
def InitGL(Width, Height):
	...
	glClearColor(0,0,0,0)	# Repeint l'arrière plan en noir à chaque nouvelle frame
	glClearDepth(1.0)	
